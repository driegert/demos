...
3. The host asks: do you want to **stay** with your door, or **switch** to the other closed door?

## What we're trying to do

Two doors are left closed. Is it better to stay, better to switch, or does it not matter?
...
4. A prediction: if you play 30 rounds, roughly how many times should *stay* win, and how many times should *switch* win?

Then open the applet at <https://driegert.github.io/demos/monte_hall/> and play at least ten rounds. Every round it shows staying and switching side by side. Record the totals, compare them with your prediction, and if they surprise you, try the hints overleaf.

\begin{center}
\begin{tabular}{|l|c|c|}
\hline
 & \textbf{Stay wins} & \textbf{Switch wins} \\ \hline
...
In each kind of round, work out whether staying or switching wins. Then ask how often each kind of round happens.
...
\hline
\textbf{Car is behind} & \textbf{Host opens} & \textbf{Stay wins?} & \textbf{Switch wins?} \\ \hline
